...
csv_file_path = r"C:\Blender\Continent_Consumption_TWH.csv"
data_column = 2
year_column = 1
...
with open(csv_file_path, 'r') as file:
    ...
    for row in csvreader:
        ...
        key = str(list(row)[year_column-1])
        year_list.append(str(row[key]))

number_of_data = len(year_list)
...
while (data_counter < number_of_data):
    ...
    text_year = str(year_list[data_counter])
    text_data = str(data_list[data_counter])
